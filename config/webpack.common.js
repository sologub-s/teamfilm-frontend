...
module.exports = function (options) {
  ...
  return {
    ...
    resolve: {
      ...
      alias: {
        'jquery.initialize': 'jquery.initialize/jquery.initialize.js',
        'headroom-jquery': 'headroom.js/dist/jQuery.headroom.js',
        headroom: 'headroom.js/dist/headroom.js',
        jquery: 'jquery/dist/jquery.js',
        bootstrap: 'bootstrap/dist/js/bootstrap.js',
        'validate.js': 'validate.js/validate.js'
      }
    ...
    module: {
      ...
      rules: [
        ...
        */
        ...
        {
          test: /[\/\\]node_modules[\/\\]headroom\.js[\/\\]dist[\/\\]headroom\.js$/,
          loader: ["babel-loader","script-loader"]
        },
        {
          test: /[\/\\]node_modules[\/\\]headroom\.js[\/\\]dist[\/\\]jQuery\.headroom\.js$/,
          loader: "script-loader"
        },
        {
          test: /[\/\\]jquery\.initialize[\/\\]jquery\.initialize\.js$/,
          loader: "script-loader"
        },
        {
